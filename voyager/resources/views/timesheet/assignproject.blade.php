                        ...
                        <div class="card card_border">
                            ...
                            <div class="cards__heading">
                                ...
                                <div style="text-align:center;">
                                    <button type="button" onClick="assignProject()"  style="margin-left:45px;" data-bs-toggle="modal" data-bs-target="#projectModal" class="bg-blue-700 text-white font-bold py-2 px-4 rounded my-3 ml-3 btn btn-primary">Assign Project</button>
                                </div>
                                                    ...
                                                    <table class="table table-bordered " id="timesheet-table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{$p->user->name}}</td>
                                                                <td><a href="/admin/assignproject/delete/{{ $p->id }}" class="btn btn-danger">Delete</a></td>
                                                            </tr>
                                                            @endforeach
                                                        </tbody>
                                                    </table>
