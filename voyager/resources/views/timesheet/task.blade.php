            ...
            <div class="card card_border">
                ...
                <div class="cards__heading">
                    ...
                    <div style="text-align:center;">
                        <button type="button" onClick="addTask()"  style="margin-left:45px;" data-bs-toggle="modal" data-bs-target="#taskModal" class="bg-blue-700 text-white font-bold py-2 px-4 rounded my-3 ml-3 btn btn-primary">Add Task</button>
                    </div>
