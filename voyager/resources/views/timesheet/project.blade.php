                    ...
                    <div class="card card_border">
                        ...
                        <div class="cards__heading">
                            ...
                            <div style="text-align:center;">
                                <button type="button" onClick="addProject()"  style="margin-left:45px;" data-bs-toggle="modal" data-bs-target="#projectModal" class="bg-blue-700 text-white font-bold py-2 px-4 rounded my-3 ml-3 btn btn-primary">Add Project</button>
                                                ...
                                                <table class="table table-bordered " id="timesheet-table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{$p->name}}</td>
                                                            <td>{{$p->user->name}}</td>
                                                            <td><a href="/admin/project/delete/{{ $p->id }}" class="btn btn-danger">Delete</a></td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
