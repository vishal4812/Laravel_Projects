            ...
            <div class="card card_border">
                ...
                <div class="cards__heading">
                    ...
                    <div style="text-align:center;">
                        <button type="button" onClick="addAttendance()"  style="margin-left:45px;" data-bs-toggle="modal" data-bs-target="#exampleModal" class="bg-blue-700 text-white font-bold py-2 px-4 rounded my-3 ml-3 btn btn-primary">Add Attendance</button>
                        <a href="{{ route('report') }}" class="bg-blue-700 text-white font-bold py-2 px-4 rounded my-3 ml-3 btn btn-primary">Report</a>
                        <button onclick="window.print()" class="bg-blue-700 text-white font-bold py-2 px-4 rounded my-3 ml-3 btn btn-primary" >Print</button>
                    </div>
